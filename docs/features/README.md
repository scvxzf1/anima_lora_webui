...
| 文档 | 状态 | 说明 |
| --- | --- | --- |
| [dragon-ui.md](dragon-ui.md) | 用户功能说明 | 默认 Dragon UI、classic 兼容回退、模式切换与空白页排查 |
...
| [tagging-workbench.md](tagging-workbench.md) | 用户功能说明 | Dragon 外部 API 打标、候选审阅与 caption 写回 |
