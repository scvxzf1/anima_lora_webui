export const FIELD_LABEL_ZH = {
    ...
    cpu_offload_checkpointing: 'CPU 检查点卸载',
    ...
    lokr_grouped_delta_backend: 'LoKr 分组 Delta 后端',
    lokr_grouped_delta_backward_backend: 'LoKr 分组 Delta 反向后端',
    use_glora: '启用 GLoRA',
    use_loha: '启用 LoHa',
    use_lokr: '启用 LoKr',
    use_vera: '启用 VeRA',
...
export const FIELD_OPTIONS = {
    ...
    lokr_grouped_delta_backend: ['eager', 'triton'],
