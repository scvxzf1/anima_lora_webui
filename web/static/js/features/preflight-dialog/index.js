...
import {
    ...
    updateStatus,
} from '../anima-app/helpers/live-status-bridge.js?v=module-bootstrap-20260831-release-v1';
...
import { outputRunRuntimeFile } from '../output-run/runtime-file.js?v=module-bootstrap-20260831-release-v1';
import { loadTrainingQueue, updateTrainingQueueFromPayload } from '../anima-app/helpers/queue-view-bridge.js?v=module-bootstrap-20260831-release-v1';
...
import { configurePreflightDialogBridge } from '../anima-app/helpers/preflight-dialog-bridge.js?v=module-bootstrap-20260831-release-v1';
import { appendLog, setTrainingHealthNotice } from '../anima-app/helpers/live-log-bridge.js?v=module-bootstrap-20260831-release-v1';
