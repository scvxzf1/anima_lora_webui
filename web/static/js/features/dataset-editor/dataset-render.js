/**
 * Dataset preset group rendering and dataset editor panel.
 * Moved out of toml-manager/config-group-drop.js.
 */

import { captureDatasetExperimentalOpenStates } from './inline-help.js?v=module-bootstrap-20260711-ir1';
import { help } from '../../config/catalog.js?v=module-bootstrap-20260711-ir1';
import { DATASET_PRESET_GROUP_STATE_KEY } from '../anima-app/helpers/app-constants.js?v=module-bootstrap-20260711-ir1';
...
import { configureDatasetRenderBridge } from '../anima-app/helpers/dataset-render-bridge.js?v=module-bootstrap-20260711-ir1';
import {
...
import { loadDatasetPreset } from './load.js?v=module-bootstrap-20260711-ir1';
import { updateDatasetPresetPageSummary } from './preset-page.js?v=module-bootstrap-20260711-ir1';
import {
...
} from '../toml-manager/file-group-drag.js?v=module-bootstrap-20260711-ir1';
import { setupConfigGroupDropTarget } from '../toml-manager/config-group-drop-target.js?v=module-bootstrap-20260711-ir1';
import { createDatasetConfigInput } from './config-input.js?v=module-bootstrap-20260711-ir1';
import { createDatasetEditorItem } from './item-drag.js?v=module-bootstrap-20260711-ir1';
import { escapeHtml } from '../config-form/field-input.js?v=module-bootstrap-20260711-ir1';
import { addDatasetEditorRow, datasetValidTargetIndices } from './mutations.js?v=module-bootstrap-20260711-ir1';
import { createDatasetEditorToolbarActions } from './toolbar.js?v=module-bootstrap-20260711-ir1';
