/**
 * Dataset config inputs and editor item drag/drop helpers.
 * Extracted from anima-app chunk 10.
 */
...
import { datasetEditorStateForActivePanel } from '../anima-app/helpers/dataset-render-bridge.js?v=module-bootstrap-20260711-ir1';
import { normalizeDatasetEditorRows } from '../anima-app/helpers/dataset-values.js?v=module-bootstrap-20260711-ir1';
import { compactPathLabel } from '../anima-app/helpers/history-task-actions-bridge.js?v=module-bootstrap-20260711-ir1';
import {
...
} from './row.js?v=module-bootstrap-20260711-ir1';
import { getDatasetState } from '../anima-app/helpers/dataset-state-bridge.js?v=module-bootstrap-20260711-ir1';
import { renderDatasetEditor } from '../anima-app/helpers/dataset-render-bridge.js?v=module-bootstrap-20260711-ir1';
import { updateDatasetDefault } from './row-fields.js?v=module-bootstrap-20260711-ir1';
import { moveDatasetEditorRow, moveDatasetEditorRowToIndex } from './mutations.js?v=module-bootstrap-20260711-ir1';
