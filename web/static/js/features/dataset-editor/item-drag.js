 ...
 */
import { datasetEditorStateForActivePanel } from '../anima-app/helpers/dataset-render-bridge.js?v=module-bootstrap-20260831-release-v1';
import { normalizeDatasetEditorRows } from '../anima-app/helpers/dataset-values.js?v=module-bootstrap-20260831-release-v1';
import { compactPathLabel } from '../anima-app/helpers/history-task-actions-bridge.js?v=module-bootstrap-20260831-release-v1';
import {
...
import { createDatasetEditorRow } from './row.js?v=module-bootstrap-20260831-release-v1';
import { getDatasetState } from '../anima-app/helpers/dataset-state-bridge.js?v=module-bootstrap-20260831-release-v1';
import { renderDatasetEditor } from '../anima-app/helpers/dataset-render-bridge.js?v=module-bootstrap-20260831-release-v1';
import { moveDatasetEditorRow, moveDatasetEditorRowToIndex } from './mutations.js?v=module-bootstrap-20260831-release-v1';
