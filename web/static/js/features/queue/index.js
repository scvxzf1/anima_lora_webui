import { fetchTrainingQueue } from './api.js?v=module-bootstrap-20260608-11';
import { createQueueActions } from './actions.js?v=module-bootstrap-20260608-11';
import { createQueueEnqueue } from './enqueue.js?v=module-bootstrap-20260608-11';
import { createQueueRenderer } from './render.js?v=module-bootstrap-20260608-11';
import {
    createQueueState,
    setQueueError,
    setQueueLoading,
