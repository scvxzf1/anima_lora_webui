...
import { createHistoryDetailDialog } from './dialog.js?v=module-bootstrap-20260831-release-v1';
import { createHistoryDetailState, normalizeHistoryDetailTab } from './state.js?v=module-bootstrap-20260831-release-v1';
...
export function createHistoryDetailFeature(ctx, deps) {
    ...
    function clearHistoryDetailState() {
        ...
        state.mainTaskReturn = null;
        state.curve.hoverStep = null;
        dialog.clearHistoryDetailContentCache();
    }
