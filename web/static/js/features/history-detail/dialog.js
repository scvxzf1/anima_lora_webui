...
import { createHistoryAnalysisRenderer } from './analysis.js?v=module-bootstrap-20260608-11';
import { createHistoryConfigFilesRenderer } from './config-files.js?v=module-bootstrap-20260608-11';
import { createHistoryLogsRenderer } from './logs.js?v=module-bootstrap-20260608-11';
import { createHistoryOverviewRenderer } from './overview.js?v=module-bootstrap-20260608-11';
import { createHistoryResumeFeature } from './resume/index.js?v=module-bootstrap-20260608-11';
import { HISTORY_DETAIL_TABS, normalizeHistoryDetailTab, setHistoryDetailTab } from './state.js?v=module-bootstrap-20260608-11';
import { createHistoryDetailWorkspace } from './workspace.js?v=module-bootstrap-20260608-11';
