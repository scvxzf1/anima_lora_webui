 ...
 */
import { ensureQueueFeature } from '../anima-app/helpers/feature-ensurers.js?v=module-bootstrap-20260831-release-v1';
...
import { showHistoryTaskConfirmDialog } from '../anima-app/helpers/history-task-actions-bridge.js?v=module-bootstrap-20260831-release-v1';
import { returnToLiveTraining } from '../anima-app/helpers/history-timeline-bridge.js?v=module-bootstrap-20260831-release-v1';
import { getGpuPicker } from '../anima-app/helpers/app-shell-startup-bridge.js?v=module-bootstrap-20260831-release-v1';
import { configureTrainingLaunchBridge } from '../anima-app/helpers/training-launch-bridge.js?v=module-bootstrap-20260831-release-v1';
import { api, val } from '../anima-app/helpers/runtime-bridge.js?v=module-bootstrap-20260831-release-v1';
import {
    hasPendingConfigChanges,
    showAppConfirmDialog,
} from '../anima-app/helpers/toml-selection-bridge.js?v=module-bootstrap-20260831-release-v1';
import {
...
} from '../anima-app/helpers/preflight-dialog-bridge.js?v=module-bootstrap-20260831-release-v1';
import { appendLog, recoverLiveTrainingState } from '../anima-app/helpers/live-log-bridge.js?v=module-bootstrap-20260831-release-v1';
import {
    setTomlStatus,
