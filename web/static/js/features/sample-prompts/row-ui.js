 ...
 */
import { formatCompactNumber } from '../history-detail/ui.js?v=module-bootstrap-20260714-stage-dataset5';
import {
    EXTRA_FIELD_HELP_ZH,
    FIELD_HELP_ZH,
    FIELD_LABEL_ZH,
...
import { normalizeLoraAdapterKind, normalizePrecisionPreference } from '../anima-app/helpers/config-values.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureConfigFieldUiBridge } from '../anima-app/helpers/config-field-ui-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { getConfigState } from '../anima-app/helpers/config-state-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { handleFormFieldChange, markSamplePromptsEditorTouched } from '../config-form/form-fields.js?v=module-bootstrap-20260714-stage-dataset5';
