...
import { readNonnegativeLiveNumber, readOptionalLiveNumber } from '../anima-app/helpers/live-form-values.js?v=module-bootstrap-20260831-release-v1';
import { configureTrainingSourceBridge } from '../anima-app/helpers/training-source-bridge.js?v=module-bootstrap-20260831-release-v1';
import { enterLiveTrainingForNewRun } from '../anima-app/helpers/training-launch-bridge.js?v=module-bootstrap-20260831-release-v1';
import { clearContinueTrainingSource as BASE_CLEAR_CONTINUE_SOURCE, refreshContinueTrainingSourceCompatibility as BASE_REFRESH_CONTINUE_SOURCE, selectContinueLoraWeight as BASE_SELECT_CONTINUE_WEIGHT } from './continue-lora.js?v=module-bootstrap-20260831-release-v1';
import {
    setTomlStatus,
...
import { getGpuPicker } from '../anima-app/helpers/app-shell-startup-bridge.js?v=module-bootstrap-20260831-release-v1';
import { renderPreflightPending, showPreflightRequestError } from '../anima-app/helpers/preflight-dialog-bridge.js?v=module-bootstrap-20260831-release-v1';
import { appendLog } from '../anima-app/helpers/live-log-bridge.js?v=module-bootstrap-20260831-release-v1';
import { getContinueTrainingSource, getTrainingSourceState, getTrainingState } from '../anima-app/helpers/training-state-bridge.js?v=module-bootstrap-20260831-release-v1';
import { showTrainingView, updateTrainingQueueFromPayload } from '../anima-app/helpers/queue-view-bridge.js?v=module-bootstrap-20260831-release-v1';
...
import { optionNodeLocal, summaryLine, textNode } from '../anima-app/helpers/training-source-ui.js?v=module-bootstrap-20260831-release-v1';
