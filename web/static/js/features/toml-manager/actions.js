 ...
 */
import { showHistoryTaskConfirmDialog, showHistoryTaskDialog } from '../anima-app/helpers/history-task-actions-bridge.js?v=module-bootstrap-20260707-93';
import { configureTomlActionsBridge } from '../anima-app/helpers/toml-actions-bridge.js?v=module-bootstrap-20260707-93';
import { loadTomlFileList } from '../anima-app/helpers/toml-manager-bridge.js?v=module-bootstrap-20260707-93';
import { api, val } from '../anima-app/helpers/runtime-bridge.js?v=module-bootstrap-20260707-93';
import { setCurrentTrainingSourceFromVariant } from '../anima-app/chunks/13-update-dataset-editor-rows-setting-value.js?v=module-bootstrap-20260707-93';
import { hasPendingConfigChanges, showAppConfirmDialog, updateTomlDirtyState, updateTomlSelectionUI } from '../anima-app/helpers/toml-selection-bridge.js?v=module-bootstrap-20260707-93';
import { isTrainingTomlGroup, reorderTomlFileGroups } from '../anima-app/helpers/toml-io-bridge.js?v=module-bootstrap-20260707-93';
import {
    applyTomlLockState,
