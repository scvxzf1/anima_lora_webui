 ...
 */
import { configureHistoryCollectionsBridge } from '../anima-app/helpers/history-collections-bridge.js?v=module-bootstrap-20260809-nf4-v2';
import {
    createHistoryCollectionWorkbenchCard,
} from './workbench-collection-card.js?v=module-bootstrap-20260809-nf4-v2';
import {
    createHistoryConfigGroupWorkbenchCard,
} from './workbench-config-group-card.js?v=module-bootstrap-20260809-nf4-v2';
import {
