...
import { setHistoryDropFeedback } from '../anima-app/helpers/history-collection-drag-bridge.js?v=module-bootstrap-20260831-release-v1';
import {
...
import { configGroupLabel } from '../anima-app/helpers/history-timeline-bridge.js?v=module-bootstrap-20260831-release-v1';
import { showTrainingView } from '../anima-app/helpers/queue-view-bridge.js?v=module-bootstrap-20260831-release-v1';
import { openHistoryConfigGroupPreview } from '../anima-app/helpers/preview-view-bridge.js?v=module-bootstrap-20260831-release-v1';
import { renderHistoryManager, saveHistoryCollectionSettings, normalizeHistoryCollectionSettings, uniqueStringList, normalizeHistoryConfigGroupOrder } from '../anima-app/helpers/history-list-bridge.js?v=module-bootstrap-20260831-release-v1';
