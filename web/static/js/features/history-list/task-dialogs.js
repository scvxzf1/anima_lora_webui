...
} from '../history-detail/system.js?v=module-bootstrap-20260831-release-v1';
...
import { clearResumeOptions, historyStateLabel, metricsWithProgressFallback, renderConfigGroupTimeline, renderHistoryPaths, renderResumePanelState } from '../anima-app/helpers/history-timeline-bridge.js?v=module-bootstrap-20260831-release-v1';
import { renderTrainingRunSummary } from '../anima-app/helpers/live-status-bridge.js?v=module-bootstrap-20260831-release-v1';
import { formatLr, lastValue, readConfigNumber } from '../live-training/index.js?v=module-bootstrap-20260831-release-v1';
...
import { setEtaMetricText, setMetricText, setText, setTrainingDashboardHeadState, syncLossChartEmptyState, updateDashboardProgressIdleState, updateTrainingToolbarState } from '../live-training/dashboard-ui.js?v=module-bootstrap-20260831-release-v1';
import { ensureHistoryDetailFeature } from '../anima-app/helpers/history-detail-bridge.js?v=module-bootstrap-20260831-release-v1';
import { closeSharedHistoryTaskDialog, openSharedHistoryTaskDialog, sharedHistoryTaskDialogIsOpen, sharedHistoryTaskDialogParts } from '../anima-app/helpers/toml-selection-bridge.js?v=module-bootstrap-20260831-release-v1';
import { renderLogOutputLines, setLogStatus } from '../anima-app/helpers/live-log-bridge.js?v=module-bootstrap-20260831-release-v1';
import { showTrainingView } from '../anima-app/helpers/queue-view-bridge.js?v=module-bootstrap-20260831-release-v1';
import { loadTrainingHistoryList, renderHistoryManager, renderTrainingHistoryList, syncRecentHistorySidebarSelection } from '../anima-app/helpers/history-list-bridge.js?v=module-bootstrap-20260831-release-v1';
