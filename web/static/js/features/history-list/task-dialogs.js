...
import { ensurePreviewFeature } from '../anima-app/helpers/feature-ensurers.js?v=module-bootstrap-20260711-ir1';
import {
...
import { clearResumeOptions, historyStateLabel, metricsWithProgressFallback, renderConfigGroupTimeline, renderHistoryPaths, renderResumePanelState } from '../anima-app/helpers/history-timeline-bridge.js?v=module-bootstrap-20260711-ir1';
import { renderTrainingRunSummary } from '../anima-app/helpers/live-status-bridge.js?v=module-bootstrap-20260711-ir1';
...
import { setEtaMetricText, setMetricText, setText, setTrainingDashboardHeadState, syncLossChartEmptyState, updateDashboardProgressIdleState, updateTrainingToolbarState } from '../live-training/dashboard-ui.js?v=module-bootstrap-20260711-ir1';
import { ensureHistoryDetailFeature } from '../anima-app/helpers/history-detail-bridge.js?v=module-bootstrap-20260711-ir1';
import { closeSharedHistoryTaskDialog, openSharedHistoryTaskDialog, sharedHistoryTaskDialogIsOpen, sharedHistoryTaskDialogParts } from '../anima-app/helpers/toml-selection-bridge.js?v=module-bootstrap-20260711-ir1';
import { renderLogOutputLines, setLogStatus } from '../anima-app/helpers/live-log-bridge.js?v=module-bootstrap-20260711-ir1';
import { showTrainingView } from '../anima-app/helpers/queue-view-bridge.js?v=module-bootstrap-20260711-ir1';
