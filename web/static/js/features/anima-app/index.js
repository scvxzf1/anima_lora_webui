...
export async function createAnimaApp(ctx) {
    ...
    await Promise.all([
        import('./chunks/03-parse-network-arg-entry.js?v=module-bootstrap-20260707-93'),
        import('./chunks/04-create-config-group-entry.js?v=module-bootstrap-20260707-93'),
        import('./chunks/05-create-stage-resolution-summary.js?v=module-bootstrap-20260707-93'),
        import('./chunks/05a-no-dataset-regularization-mode.js?v=module-bootstrap-20260707-93'),
        import('./chunks/06-stronger-selective-checkpoint-value.js?v=module-bootstrap-20260707-93'),
        import('./chunks/07-render-config-dataset-picker-dialog.js?v=module-bootstrap-20260707-93'),
        import('./chunks/08-origin-closest.js?v=module-bootstrap-20260707-93'),
        import('./chunks/09-setup-config-group-drop-target.js?v=module-bootstrap-20260707-93'),
        import('./chunks/10-create-dataset-config-input.js?v=module-bootstrap-20260707-93'),
        import('./chunks/10a-dataset-inline-help.js?v=module-bootstrap-20260707-93'),
        import('./chunks/11-create-dataset-editor-row.js?v=module-bootstrap-20260707-93'),
        import('./chunks/12-create-dataset-row-caption-source-mode-editor.js?v=module-bootstrap-20260707-93'),
        import('./chunks/13-update-dataset-editor-rows-setting-value.js?v=module-bootstrap-20260707-93'),
        import('./chunks/14-lora-adapter-kind-from-config.js?v=module-bootstrap-20260707-93'),
        import('./chunks/15-append-sample-prompt-row.js?v=module-bootstrap-20260707-93'),
        import('./chunks/16-load-output-run-config.js?v=module-bootstrap-20260707-93'),
        import('./chunks/17-apply-selected-dataset-preset-to-current-config.js?v=module-bootstrap-20260707-93'),
        import('./chunks/18-delete-dataset-preset-group.js?v=module-bootstrap-20260707-93'),
    ...
    const [
        ...
        import('./chunks/26a-global-settings.js?v=module-bootstrap-20260707-93'),
        import('./chunks/26b-preview-view.js?v=module-bootstrap-20260707-93'),
        import('./chunks/26c-queue-view.js?v=module-bootstrap-20260707-93'),
        import('./chunks/26d-history-list.js?v=module-bootstrap-20260707-93'),
    ]);
    ...
    await Promise.all([
        import('./chunks/27-render-history-collections-workbench.js?v=module-bootstrap-20260707-93'),
        import('./chunks/28-history-collection-search-text.js?v=module-bootstrap-20260707-93'),
        import('./chunks/29-start-history-config-group-pointer-drag.js?v=module-bootstrap-20260707-93'),
        import('./chunks/30-start-history-collection-pointer-drag.js?v=module-bootstrap-20260707-93'),
        import('./chunks/31-create-history-collection-workbench-card.js?v=module-bootstrap-20260707-93'),
        import('./chunks/32-history-task-collection-label.js?v=module-bootstrap-20260707-93'),
        import('./chunks/33-create-history-task-item.js?v=module-bootstrap-20260707-93'),
        import('./chunks/34-show-history-collection-select-dialog.js?v=module-bootstrap-20260707-93'),
        import('./chunks/35-render-config-group-timeline.js?v=module-bootstrap-20260707-93'),
    ]);
    await Promise.all([
        import('./chunks/36-setup-event-listeners.js?v=module-bootstrap-20260707-93'),
        import('./chunks/37-config-training-source.js?v=module-bootstrap-20260707-93'),
    ]);
