 ...
 */
import { configureAppShellStateBridge } from './helpers/app-shell-state-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureAppContextBridge } from './helpers/app-context-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureConfigStateBridge } from './helpers/config-state-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureDatasetStateBridge } from './helpers/dataset-state-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureHistoryStateBridge } from './helpers/history-state-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureImageTestBridge } from './helpers/image-test-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureRuntimeBridge } from './helpers/runtime-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureStatusPollingBridge } from './helpers/status-polling-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureGlobalSettingsBridge } from './helpers/global-settings-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configurePreviewViewBridge } from './helpers/preview-view-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureQueueViewBridge } from './helpers/queue-view-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureHistoryListBridge } from './helpers/history-list-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureTomlStateBridge } from './helpers/toml-state-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { configureTrainingStateBridge } from './helpers/training-state-bridge.js?v=module-bootstrap-20260714-stage-dataset5';
import { createAnimaRuntime } from './runtime.js?v=module-bootstrap-20260714-stage-dataset5';
...
export async function createAnimaApp(ctx) {
    ...
    const appShellModule = await import('./chunks/02-ensure-history-detail-feature.js?v=module-bootstrap-20260714-stage-dataset5');
    ...
    await Promise.all([
        ...
        import('./chunks/10-create-dataset-config-input.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/10a-dataset-inline-help.js?v=module-bootstrap-20260714-stage-dataset5'),
    ...
    await import('./chunks/26-load-global-settings.js?v=module-bootstrap-20260714-stage-dataset5');
    ...
    const statusPollingModule = await import('./chunks/26a-status-polling.js?v=module-bootstrap-20260714-stage-dataset5');
    ...
    await Promise.all([
        import('./chunks/27-render-history-collections-workbench.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/28-history-collection-search-text.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/29-start-history-config-group-pointer-drag.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/30-start-history-collection-pointer-drag.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/31-create-history-collection-workbench-card.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/32-history-task-collection-label.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/33-create-history-task-item.js?v=module-bootstrap-20260714-stage-dataset5'),
        import('./chunks/34-show-history-collection-select-dialog.js?v=module-bootstrap-20260714-stage-dataset5'),
