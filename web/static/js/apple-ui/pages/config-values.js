import { FORM_UI_DEFAULTS, NETWORK_ARG_FIELD_MAP } from '../../config/catalog/defaults.js?v=apple-ui-20260812v33';
import { coerceNetworkArgValue, formatNetworkArg, parseNetworkArgEntry } from '../../features/anima-app/helpers/network-args.js?v=apple-ui-20260812v33';
import { loraAdapterFlagsForKind, loraAdapterKindFromConfig, precisionPreferenceFromConfig, precisionPreferencePatch } from '../../features/anima-app/helpers/config-values.js?v=apple-ui-20260812v33';
...
export function serializeConfigValue(input, originalValue) {
    if (input.classList.contains('apple-toggle')) return input.dataset.checked === 'true';
