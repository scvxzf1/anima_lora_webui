import { FORM_SECTION_DEFS } from '../../config/catalog/form-layout.js?v=apple-ui-20260812v33';

export const CONFIG_KEY_OVERRIDES = {
    'data-behavior': ['use_shuffled_caption_variants', 'masked_loss', 'caption_dropout_rate'],
    'dataset-filter': ['path_pattern', 'drop_lowres_images', 'min_pixels'],
    optimizer: ['optimizer_type', 'optimizer_args', 'lr_scheduler', 'lr_warmup_steps', 'learning_rate'],
