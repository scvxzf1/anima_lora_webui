import { ensureDragonRouteStyles } from './route-styles.js?v=dragon-ui-20260831v14';
...
export function createDragonPageLoaders() {
    ...
    const loadCaptioning = lazyPage(
        () => import('./pages/captioning.js?v=dragon-ui-20260831v8'),
        'loadCaptioning',
    );
    return {
        dashboard: styledPage('dashboard', lazyPage(() => import('./pages/dashboard.js?v=dragon-ui-20260826v45'), 'loadDashboard')),
        config: styledPage('config', lazyPage(() => import('./pages/config-page.js?v=dragon-ui-20260831v153'), 'loadConfigPage')),
        ...
        'captioning-prompts': styledPage('captioning', lazyPage(
            () => import('./pages/tagging-prompt-presets-page.js?v=dragon-ui-20260831v3'),
            'loadTaggingPromptPresetsPage',
        )),
        'captioning-results': styledPage('captioning', lazyPage(
            () => import('./pages/tagging-results-page.js?v=dragon-ui-20260831v3'),
            'loadTaggingResultsPage',
        )),
        'captioning-logs': styledPage('captioning', lazyPage(
            () => import('./pages/tagging-logs-page.js?v=dragon-ui-20260831v3'),
            'loadTaggingLogsPage',
        )),
    };
}
