...
| Path | Role |
|------|------|
| `lora_anima/` | LoRA network creation, module targeting, persistence, router diagnostics, optimizer param groups, routing-state orchestration, global routing. Split into `network.py`, `factory.py`, `loading.py`, `config.py`, `persistence.py`, `router_stats.py`, `optimizer_groups.py`, and `routing_state.py`. |
