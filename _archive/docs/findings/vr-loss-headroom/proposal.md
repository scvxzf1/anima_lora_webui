...
状态：历史提案
适用版本：2026-05，当前说明见 `docs/experimental/vr_loss.md`
原始路径：`bench/fm_vr_headroom/proposal.md`（删除前提交 `dded0bc6^`）
...
this directory's [`README.md`](README.md) and the now-retired historical
`run_bench.py` harness
