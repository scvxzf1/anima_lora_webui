...
def _anima_app_container_text() -> str:
    ...
    paths = [
        ...
        *sorted((STATIC_DIR / "js/features/anima-app/chunks").glob("*.js")),
        ...
        STATIC_DIR / "js/features/history-list/workbench-collection-card.js",
        STATIC_DIR / "js/features/history-list/workbench-config-group-card.js",
        STATIC_DIR / "js/features/history-list/workbench-order.js",
        STATIC_DIR / "js/features/history-list/collections-workbench.js",
        STATIC_DIR / "js/features/history-list/task-collections.js",
        STATIC_DIR / "js/features/history-list/task-dialogs.js",
