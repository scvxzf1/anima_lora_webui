...
def test_live_status_merges_current_history_task_without_full_history_fetch() -> None:
    ...
    script = r"""
import { configureHistoryStateBridge } from './web/static/js/features/anima-app/helpers/history-state-bridge.js?v=module-bootstrap-20260831-release-v1';
import { configureTrainingStateBridge } from './web/static/js/features/anima-app/helpers/training-state-bridge.js?v=module-bootstrap-20260831-release-v1';
...
def test_history_detail_overview_uses_full_copyable_paths_and_resume_weights() -> None:
    ...
    assert "from './config-chips.js?v=module-bootstrap-20260831-release-v1'" in overview_source
