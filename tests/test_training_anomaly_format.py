...
from web.services.training_service import TrainingService, format_training_anomaly
...
def test_training_error_classifier_detects_cuda_oom():
    text = "torch.OutOfMemoryError: CUDA out of memory. Tried to allocate 64.00 MiB."
